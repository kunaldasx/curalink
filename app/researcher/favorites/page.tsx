...
import { Bookmark, FlaskConical, BookOpen, Users, BookmarkX, ExternalLink, MapPin, Mail, Building, UserPlus } from 'lucide-react';
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Your saved clinical trials, publications, and collaborators</p>
      </div>
        ...
        <Card className="border-dashed">
          <CardContent className="pt-6 text-center py-12">
            ...
            <p className="text-muted-foreground mb-4">
              Build your research library by saving relevant clinical trials, publications, and collaborators
            </p>
            <div className="flex gap-2 justify-center">
              <Button onClick={() => router.push('/researcher/trials')}>
                Browse Clinical Trials
              </Button>
              <Button variant="outline" onClick={() => router.push('/researcher/experts')}>
                Find Collaborators
              </Button>
            </div>
          </CardContent>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList>
            ...
            <TabsTrigger value="collaborators">
              ...
              Collaborators ({groupedFavorites.collaborator.length})
            </TabsTrigger>
          </TabsList>
              ...
              <div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {groupedFavorites.collaborator.map((fav) => (
                    <CollaboratorCard key={fav._id} favorite={fav} onRemove={handleRemoveFavorite} />
                  ))}
                </div>
              </div>
            )}
            ...
            {groupedFavorites.collaborator.length === 0 ? (
              <Card className="border-dashed">
                <CardContent className="pt-6 text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-2">No saved collaborators yet</p>
                  <Button variant="outline" size="sm" onClick={() => router.push('/researcher/experts')}>
  ...
  return (
    <Card className="hover:shadow-md transition-shadow border-l-4 border-l-purple-600">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            ...
            {collaborator.specialization && (
              <Badge className="mb-2 bg-purple-600">{collaborator.specialization}</Badge>
            )}
          ...
          <Button
            variant="ghost"
            size="sm"
            onClick={() => onRemove('collaborator', collaborator._id)}
            className="text-red-600 hover:text-red-700"
          >
            <BookmarkX className="h-4 w-4" />
          </Button>
      ...
      {collaborator.researchFocus && (
        <CardContent>
          <p className="text-sm text-gray-600 line-clamp-2 mb-3">{collaborator.researchFocus}</p>
          <Button variant="outline" size="sm">
