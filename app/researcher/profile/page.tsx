		...
		<div className="max-w-4xl mx-auto">
			...
			<Card className="mb-6">
				<CardHeader>
					...
					<CardDescription>
						{isEditing
							? "Update your research focus areas"
			...
			<Card className="mb-6">
				<CardHeader>
					...
					<CardDescription>
						Link your academic profiles for publication import
					</CardDescription>
				</CardHeader>
				<CardContent className="space-y-4">
					<div className="space-y-2">
					...
					<div className="space-y-2">
						...
						{isEditing ? (
							<Input
								...
								onChange={(e) =>
									setResearchGateUrl(e.target.value)
								}
							/>
						) : (
							<p className="text-sm py-2">
								{user?.researchGateUrl || "Not linked"}
							</p>
						)}
					</div>
				</CardContent>
			...
			<Card className="mb-6">
				<CardHeader>
					...
					<CardDescription>
						Control your availability for patient consultations
					</CardDescription>
				</CardHeader>
				<CardContent>
					{isEditing ? (
						<div className="flex items-start space-x-3 p-4 bg-blue-50 rounded-md">
							...
							<div>
								...
								>
									I'm available for meeting requests from
									patients
								</Label>
								<p className="text-xs text-muted-foreground mt-1">
									Patients can request meetings to discuss
						...
						<div className="flex items-center gap-3">
							...
							<Badge
								variant={
									acceptsMeetings ? "default" : "secondary"
								}
							>
								{acceptsMeetings
									? "Available"
