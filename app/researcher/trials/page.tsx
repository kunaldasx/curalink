		...
		<div className="max-w-7xl mx-auto">
			<div className="mb-8">
				...
				<p className="text-gray-600">
					Discover clinical trials for collaboration and research
					opportunities
				</p>
			</div>
					...
					<div className="space-y-4">
						...
						<div>
							...
							<p className="text-xs text-muted-foreground mt-1">
								Search by condition, treatment type, phase, or
								keywords
							</p>
						</div>
					...
					<DialogContent className="max-w-2xl">
						...
						<div className="space-y-4">
							...
							<div>
								...
								/>
								<p className="text-xs text-muted-foreground mt-1">
									Customize this message to introduce yourself
									and your collaboration interests
								</p>
							</div>
						</div>
						<DialogFooter>
