...
import { Plus, Edit, Search, MapPin, Bookmark, Globe, RefreshCw, Mail, Sparkles, Loader2, Filter, X, Briefcase } from 'lucide-react';
          ...
          {loadingMyTrials ? (
            <Card>
              <CardContent className="pt-6 text-center py-8">
                ...
                <p className="text-muted-foreground">Loading your trials...</p>
              </CardContent>
            </Card>
          ) : myTrials.length === 0 ? (
            <Card>
        ...
        <TabsContent value="browse" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Search for trials by condition, treatment type, phase, or keywords
                  </p>
                </div>
          ...
          {allTrials.length > 0 && (
            <div className="flex items-center justify-between">
              <p className="text-sm text-muted-foreground">
                Showing {allTrials.length} trial{allTrials.length !== 1 ? 's' : ''}
              </p>
            </div>
          )}
