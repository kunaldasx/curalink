	...
	const fetchPublications = async () => {
		...
		try {
			const response = await fetch(
				"/api/researcher/import-publications",
				{
					method: "POST",
								...
								<div className="space-y-4">
									...
									<div className="flex items-start gap-3 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200">
										...
										<p className="text-sm text-gray-700">
											Your specialties and location help
											categorize your profile and connect
								...
								<div className="space-y-4">
									...
									{researchInterests.length > 0 && (
										<div className="p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border border-purple-200">
											...
											<p className="text-sm text-gray-700">
												We'll recommend relevant trials,
						...
						{currentStep === 3 && (
							<div className="space-y-8 animate-fade-in-up">
								<div className="text-center mb-8">
									...
									<p className="text-lg text-gray-600">
										Link your profiles to auto-import
										publications
									</p>
								...
								<div className="space-y-6">
									<div className="space-y-3">
										...
										<p className="text-xs text-gray-500">
											Auto-import your credentials and
									...
									<div className="space-y-3">
										...
										/>
										<p className="text-xs text-gray-500">
											Pull your academic contributions and
										...
										<div className="space-y-3">
											<div className="p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl border border-green-200">
												...
												<p className="text-xs text-gray-600">
													AI-generated summaries will
													be created for your
													publications to help
													patients understand your
													work
												</p>
											</div>
									...
									<div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200">
										...
										<p className="text-sm text-gray-700">
											Your publications will be displayed
											with AI-generated summaries that are
											simple and clear for patients to
											understand
										</p>
									</div>
								</div>
									...
									<div className="p-6 bg-gradient-to-r from-pink-50 to-purple-50 rounded-xl border-2 border-pink-200">
										<div className="flex items-start gap-4">
											...
											<div className="flex-1">
												<Label
													htmlFor="acceptsMeetings"
													className="text-base font-semibold text-gray-800 cursor-pointer"
												>
													I'm available for meeting
													requests from patients
												</Label>
												<p className="text-sm text-gray-600 mt-2">
													Patients seeking expert
													guidance can request
								...
								<div className="p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border border-purple-200">
									...
									<ul className="space-y-2 text-sm text-gray-700">
										<li className="flex items-start gap-2">
											<Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
											<span>
												Your profile becomes visible to
												patients seeking experts
											</span>
										</li>
										<li className="flex items-start gap-2">
											<Check className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
											<span>
												Receive collaboration and trial
