			...
			<div className="w-full max-w-4xl">
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Provide background and expertise to connect with
							relevant opportunities and collaborators.
						</CardDescription>
					</CardHeader>
					<CardContent>
						<form onSubmit={handleSubmit} className="space-y-6">
							...
							<div className="space-y-3">
								...
								<p className="text-sm text-muted-foreground">
									Mention areas like Oncology, Neurology, or
									Immunology to categorize your profile.
								</p>
							...
							<div className="space-y-3">
								...
								<p className="text-sm text-muted-foreground">
									Add areas like Immunotherapy, Clinical AI,
									or Gene Therapy to receive relevant
									recommendations.
								</p>
								<div className="flex gap-2">
									<Input
							...
							<div className="space-y-3 border-t pt-6">
								<div>
									...
									<p className="text-sm text-muted-foreground mt-1">
										Link your ORCID or ResearchGate to
										automatically fetch your publications
							...
							<div className="space-y-3 border-t pt-6">
								...
								<div className="flex items-start space-x-3 p-4 bg-blue-50 rounded-md">
									<input
										...
										onChange={(e) =>
											setAcceptsMeetings(e.target.checked)
										}
									...
									<div>
										...
										>
											I'm available for meeting requests
											from patients
										</Label>
										<p className="text-xs text-muted-foreground mt-1">
											Patients can request meetings to
											discuss their conditions and
											treatment options.
										</p>
									</div>
								</div>
							...
							<div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-lg">
								...
								<ul className="text-sm text-muted-foreground space-y-1">
									<li>
										...
										patients seeking expertise
									</li>
									<li>
										✓ You'll receive relevant collaboration
										opportunities
									</li>
									<li>
										✓ Access clinical trial management and
										collaboration tools
									</li>
								</ul>
							</div>
