    ...
    <div className="max-w-4xl mx-auto">
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm text-blue-800">
                Refreshing your personalized recommendations based on updated profile...
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent className="space-y-4">
          {isEditing && (
            <>
              ...
              <div className="space-y-2">
                <Label htmlFor="naturalLanguage">Describe your situation (optional)</Label>
                <Textarea
                  id="naturalLanguage"
                ...
                <p className="text-xs text-muted-foreground">
                  AI will extract relevant conditions from your description
                </p>
              </div>
          ...
          {isEditing && (
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-4 rounded-lg">
              <p className="text-sm font-medium mb-2">💡 Why update your profile?</p>
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>✓ Get more relevant clinical trial recommendations</li>
                <li>✓ Connect with experts specialized in your conditions</li>
                <li>✓ Discover the latest research publications</li>
                <li>✓ Receive personalized nearby and global results</li>
              </ul>
            </div>
          )}
        </CardContent>
      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          ...
          <div className="flex justify-between text-sm">
            <span className="text-muted-foreground">Tracked Conditions:</span>
