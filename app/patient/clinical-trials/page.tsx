...
import { Search, MapPin, Heart, Globe, RefreshCw, Mail, Sparkles, Loader2, Filter, X } from 'lucide-react';
      ...
      <div className="space-y-4">
        ...
        <Dialog open={emailDialogOpen} onOpenChange={setEmailDialogOpen}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              <DialogTitle>Contact Trial Administrator</DialogTitle>
              <DialogDescription>
                {selectedTrial?.title}
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                <p className="text-xs text-muted-foreground mt-1">
                  Feel free to customize this message with your questions
                </p>
              </div>
