...
export default function PatientOnboarding() {
	...
	const removeCondition = (condition: string) => {
		setAdditionalConditions(
			additionalConditions.filter((c) => c !== condition)
		);
	};
					...
					<div className="relative h-4 md:h-5 bg-white/20 rounded-full overflow-visible shadow-sm mt-8 mx-4 mb-8 md:mb-10">
						...
						<div
							...
							style={{
								...
								background:
									"linear-gradient(90deg, #14b8a6 0%, #06b6d4 25%, #6366f1 50%, #8b5cf6 75%, #a855f7 100%)",
							}}
						>
							{/* Shine effect */}
							<div
								...
								<div className="space-y-4">
									...
									<div className="flex items-start gap-3 p-4 bg-gradient-to-r from-medical-teal-50 to-medical-indigo-50 rounded-xl border border-medical-teal-200">
										...
										<p className="text-sm text-gray-700">
											Our AI will understand your needs
						...
						{currentStep === 2 && (
							<div className="space-y-8 animate-fade-in-up">
								<div className="text-center mb-8">
									...
									<p className="text-lg text-gray-600">
										This helps us find the most relevant
										matches
									</p>
						...
						{currentStep === 3 && (
							<div className="space-y-8 animate-fade-in-up">
								<div className="text-center mb-8">
									...
									<p className="text-lg text-gray-600">
										We'll show you nearby experts and
										clinical trials
									</p>
								</div>
								...
								<div className="space-y-6">
									...
									<div className="flex items-start gap-3 p-5 bg-gradient-to-r from-medical-teal-50 to-medical-indigo-50 rounded-xl border border-medical-teal-200">
										...
										<p className="text-sm text-gray-700">
											You can always view global results
											anytime
										</p>
									</div>
								</div>
						...
						{currentStep === 4 && (
							<div className="space-y-8 animate-fade-in-up">
								<div className="text-center mb-8">
									...
									<p className="text-lg text-gray-600">
										We'll prioritize these in your
										recommendations
									</p>
									<p className="text-sm text-gray-500 mt-2">
