			...
			<div className="max-w-7xl mx-auto">
				...
				<div className="mb-8 p-6 md:p-8 rounded-3xl bg-gradient-to-br from-medical-teal-50 via-medical-indigo-50 to-medical-lavender-50 border border-medical-teal-100 shadow-lg animate-fade-in-up">
					...
					<p className="text-lg text-gray-700">
						💬 Ask questions and get verified answers from medical
						...
						<div className="flex items-start gap-4">
							...
							<div className="flex-1">
								...
								<div className="space-y-2 text-sm text-gray-700">
									...
									<p className="flex items-center gap-2">
										✓ Post your questions in relevant
										categories
									</p>
									<p className="flex items-center gap-2">
										✓ All answers are from medical
										professionals
									</p>
									<p className="flex items-center gap-2">
				...
				<div className="space-y-4">
					{loading && (
						<Card>
							<CardContent className="pt-6 text-center py-8 flex justify-center">
		...
		<div className="max-w-7xl mx-auto">
			...
			<div className="space-y-3">
				...
				{topics.map((topic) => (
					<Link
						key={topic._id}
						href={`/patient/forums/topic/${topic._id}`}
					>
